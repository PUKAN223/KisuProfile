...
const educationData = [
  {
    ...
    description:
      "Studying in an intensive science and mathematics program with a focus on analytical thinking, research skills, and advanced STEM education.",
  ...
  },
  {
    ...
    school:
      "Science Classrooms in University Affiliated School (SCIUS) - Thaksin University",
    description:
      "Studied in the SCIUS program focusing on science, mathematics, and research-based learning with university collaboration.",
    skills: ["Mathematics", "Science Research"],
  },
];
...
export function EducationTimeline({ visible }: EducationTimelineProps) {
  ...
  return (
    <div
      className={`fixed inset-0 z-20 flex items-center justify-center pointer-events-none transition-opacity duration-700 ease-in-out ${
    ...
    >
      <div className="max-w-4xl w-full px-6 py-12 md:py-20 h-full overflow-y-auto scrollbar-hide flex flex-col items-center justify-center">
        <div
          className="text-center mb-12 transform transition-all duration-700 delay-100"
          style={{
        ...
        <div className="relative w-full max-w-2xl ml-4 md:ml-0">
          ...
          <div className="space-y-12">
            {educationData.map((item, index) => (
              <div
                key={index}
                className={`relative flex flex-col md:flex-row gap-8 md:gap-0 transform transition-all duration-700 ${
              ...
              >
                ...
                {/* Content Side */}
                <div
                  className={`md:w-1/2 flex flex-col gap-2 pl-6 md:pl-0 text-left ${
                ...
                >
                  ...
                  >
                    <span
                      className={`text-blue-300 text-sm font-mono flex items-center gap-2 ${
                    ...
                    >
                      {item.skills.map((skill) => (
                        <Badge
                          key={skill}
                          variant="secondary"
                          className="bg-blue-500/10 hover:bg-blue-500/20 text-blue-200 border border-blue-500/20 text-[10px]"
                        >
                          {skill}
                        </Badge>
                      ))}
